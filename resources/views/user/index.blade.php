...
@section('navbar_content')
    ...
    <div x-data="{ openModal: false }">
        ...
        <section class="relative bg-gradient-to-r from-[#0f5132] via-[#198754] to-[#145a32] text-white py-16">
            <div
                class="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-12 gap-10">
                ...
                <div class="w-full md:w-1/2 space-y-6 text-center md:text-left">
                    ...
                    <h1 data-aos="fade-left"
                        class="text-3xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-green-800 drop-shadow-lg stroke-text">
                    ...
                    <p data-aos="fade-left"
                        class="text-base sm:text-lg lg:text-xl text-gray-100 leading-relaxed max-w-lg mx-auto md:mx-0">
                ...
                <div class="w-full md:w-1/2 flex justify-center">
                    <img src="{{ \App\Models\Setting::get(\App\Models\Setting::KEY_EVENT_BANNER_URL) }}" alt="Banner Event"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-lg font-bold tracking-wide mt-1">{{ $day }} {{ $month }}
                            {{ $year }}</p>
                    </div>
                </div>
            ...
            <div class="border-t border-black pt-4" data-aos="fade-left">
                <div class="flex flex-col gap-4 mb-4">
                    ...
                    <img src="{{ \App\Models\Setting::get(\App\Models\Setting::KEY_EVENT_BENEFITS_URL) }}"
                        alt="Benefit Peserta" class="w-full max-w-xl mx-auto rounded object-contain">
                </div>
            </div>
        </section>
        ...
        <section class="bg-cover bg-black bg-center py-10 text-white text-center"
            style="background-image : url('/asset/Rect Light.svg')">
                ...
                @foreach ($rundowns as $item)
                    ...
                    @if (!$isEven)
                        ...
                        <div class="mb-12 flex justify-end items-center relative" data-aos="fade-left">
                            ...
                            <!-- Titik -->
                            <div
                                class="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 
