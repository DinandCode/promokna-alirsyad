...
@section('navbar_content')
    ...
    <div class="flex justify-center items-center min-h-screen bg-gray-100 p-8">
        <div class="bg-white mt-14 shadow-lg rounded-2xl p-8 w-full max-w-3xl ">
            <h2 class="text-2xl font-bold text-center text-gray-700 mb-6">Pendaftaran
                ...
                @else
                    <div class="flex gap-5 md:flex-row flex-col" x-data="{
                        ...
                        form: {
                            ...
                            address: '{{ old('address') }}',
                            city: '{{ old('city') }}',
                            jersey_size: '{{ old('jersey_size', 'XXS') }}',
                        ...
                        validateStep() {
                            const fields = [
                                ...
                                ['gender', 'birthplace', 'birthdate', 'address', 'city', 'jersey_size'],
                                ['blood_type']
                            ];
                        ...
                        <!-- Steps -->
                        <div
                            class="flex md:flex-col md:w-1/4 md:pr-4 space-x-4 md:space-x-0 md:space-y-4 border-b md:border-b-0 md:border-r pb-4 md:pb-0">
                            <template x-for="(label, index) in ['Data Umum', 'Biodata', 'Data Kesehatan']"
                                ...
                                <button @click="step = index + 1" class="flex px-3 py-2 rounded-lg w-full"
                                    :class="step === index + 1 ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'">
                        ...
                        <form class="md:w-3/4 p-4" id="registrationForm" method="POST"
                            action="{{ route('user.attempt-register') }}">
                            @csrf
                            ...
                            <div class="p-4 mb-4 bg-blue-200 rounded-lg">
                            ...
                            <div x-show="step === 2" class="space-y-4">
                                ...
                                <div>
                                    <label for="jersey_size">Ukuran Jersey</label>
                            ...
                            <div x-show="step === 3" class="space-y-4">
                                ...
                                <div class="mb-4 flex items-center mt-2">
                                    <input type="checkbox" id="terms"
                                        class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500" required>
                                    <label for="terms" class="ml-2 text-gray-600">Saya menyetujui <a
                                            href="{{ route('home.sk') }}" target="_blank"
                                            class="text-blue-500 hover:underline">syarat & ketentuan</a></label>
                                </div>
                            ...
                            <div class="mt-4 flex justify-between">
                                ...
                                <button x-show="step === 3" type="button" @click="submit()" disabled
                                    class="px-4 py-2 bg-green-500 text-white rounded disabled:bg-green-300"
