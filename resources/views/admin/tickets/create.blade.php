            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.tickets.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="type_match" name="type_match" value="{{ old('type_match') }}" required
                            class="mt-1 block w-full p-2 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="max_tries" name="max_tries" value="{{ old('max_tries') }}"
                            class="mt-1 block w-full p-2 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="bib_prefix" name="bib_prefix" value="{{ old('bib_prefix') }}"
                            class="mt-1 block w-full p-2 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    </div>
